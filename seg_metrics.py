...
label_1 = [item for array in label_all for item in array.flatten()]
predict_1 = [item for array in predict_all for item in array.flatten()]
label_all= np.array(label_1)
predict_all=np.array(predict_1)
