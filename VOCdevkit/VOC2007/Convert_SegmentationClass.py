...
#-----------------------------------------------------------------------------------#
Origin_SegmentationClass_path   = r"D:\PycharmProjects\really\111\VOCdevkit\VOC2007\SegmentationClass"
Out_SegmentationClass_path      = r"D:\PycharmProjects\really\111\VOCdevkit\VOC2007\SegmentationClass"
...
if __name__ == "__main__":
    ...
    for png_name in tqdm(png_names):
        ...
        out_png = Image.fromarray(np.array(png, np.uint8))
